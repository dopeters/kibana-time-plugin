...
angular.module("BootstrapAddonsTemplateCache", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("timeslider/timeslider.html", "<div><div class=\"btn-group\"><button class=\"btn btn-xs btn-primary\" ng-click=\"togglePlay()\"><span class=\"fa {{actionIcon}}\"></span></button> <button class=\"btn btn-xs btn-primary\" ng-click=\"stepBack()\"><span class=\"fa fa-backward\"></span></button> <button class=\"btn btn-xs btn-primary\" ng-click=\"stepForward()\"><span class=\"fa fa-forward\"></span></button> <span id=\"ba-timeslider-container\"></span></div></div>");
}]);